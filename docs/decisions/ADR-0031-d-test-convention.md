# ADR-0031 — d-numbered regression test convention
...
1. `@developer`: when authoring a new d-test, follow this ADR's header + body skeleton. Reference ADR-0031 in the PR body.
