...
|---|---|---|---|
| [atilproject/AtilCalculator ADR-0060](./../AtilCalculator/docs/decisions/ADR-0060-ac-mapping-verification-doctrine.md) | §AC Mapping Verification Doctrine | tmpl ADR-0060 = Claude Code 2.1.207 agent-flag | ✅ **RESOLVED** (S32-027-B, Issue #164): renumbered → **tmpl ADR-0061** (`ADR-0061-ac-mapping-verification-doctrine.md`). Original proposal ADR-0072 now taken (soul-sync); free `0061` tbd-slot used. |
| [atilproject/AtilCalculator ADR-0061](./../AtilCalculator/docs/decisions/ADR-0061-claude-code-agent-flag-removal.md) | Claude Code 2.1.207 — Remove `--agent` Flag | tmpl ADR-0060 (same doctrine under different number) | ✅ **RESOLVED** (S32-027-B, Issue #164): NO PORT — duplicate doctrine already in tmpl ADR-0060. Calc-side deletion tracked by AtilCalculator PR #1178 (REMOVE calc ADR-0061). |
| [atilproject/AtilCalculator ADR-0059](./../AtilCalculator/docs/decisions/ADR-0059-cluster-squash-batch-lag-detection.md) | Cluster-Squash Batch-Lag Detection Doctrine | tmpl ADR-0059-cluster-squash-batch-lag-detection.md (same name, byte-equal content) | ✅ **RESOLVED** (S32-027-B, Issue #164): file already synced; stale INDEX `RESERVED — Sprint 28` status + broken link (`-lag.md` → `-lag-detection.md`) corrected in this PR. |
| [atilproject/AtilCalculator ADR-0062](./../AtilCalculator/docs/decisions/ADR-0062-amendment-layer-5-label-change-verdict-gate.md) | §Layer 5 Label-Change Verdict-Gate Extension (amendment) | tmpl ADR-0062 RESERVED | ✅ **RESOLVED** (S32-027-B, Issue #164): ported → tmpl ADR-0062 (reserved sister slot; same number, no renumber). |
| [atilproject/AtilCalculator ADR-0063](./../AtilCalculator/docs/decisions/ADR-0063-amendment-layer-4-cascade-strip-lane-transition-skip.md) | §Layer 4 Cascade-Strip Lane-Transition Skip (amendment) | tmpl ADR-0063 RESERVED | ✅ **RESOLVED** (S32-027-B, Issue #164): ported → tmpl ADR-0063 (reserved sister slot; same number). |
| [atilproject/AtilCalculator ADR-0064](./../AtilCalculator/docs/decisions/ADR-0064-cross-user-env-var-pattern.md) | Cross-User Env Var Pattern | tmpl ADR-0064 RESERVED | ✅ **RESOLVED** (S32-027-B, Issue #164): ported → tmpl ADR-0064 (reserved sister slot; clean port). |
| [atilproject/AtilCalculator ADR-0065](./../AtilCalculator/docs/decisions/ADR-0065-cpython-3-12-13-asyncio-get-running-loop-fix.md) | CPython Tool-Cache + asyncio fix | tmpl ADR-0065 RESERVED | ✅ **RESOLVED** (S32-027-B, Issue #164): ported → tmpl ADR-0065 (reserved sister slot; clean port). |
